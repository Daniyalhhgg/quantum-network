  ...
  >
    <div
      style={{
        ...
        overflow: "visible", // ensures SVG edges are visible
      }}
    >
      <svg
      ...
      >
        ...
        <circle cx="160" cy="160" r="110" stroke="#2AA6FF" strokeWidth="3" opacity="0.85" />

        <g stroke="#2AA6FF" strokeWidth="2">
          <circle cx="160" cy="50" r="6" fill="#2AA6FF" />
          <circle cx="230" cy="75" r="6" fill="#2AA6FF" />
          <circle cx="265" cy="145" r="6" fill="#2AA6FF" />
          <circle cx="240" cy="215" r="6" fill="#2AA6FF" />
          <circle cx="160" cy="260" r="6" fill="#2AA6FF" />
          <circle cx="80" cy="215" r="6" fill="#2AA6FF" />
          <circle cx="55" cy="145" r="6" fill="#2AA6FF" />
          <circle cx="90" cy="75" r="6" fill="#2AA6FF" />
        </g>

        <g stroke="#2AA6FF" strokeWidth="2" opacity="0.6">
          <line x1="160" y1="50" x2="230" y2="75" />
          <line x1="230" y1="75" x2="265" y2="145" />
          <line x1="265" y1="145" x2="240" y2="215" />
          <line x1="240" y1="215" x2="160" y2="260" />
          <line x1="160" y1="260" x2="80" y2="215" />
          <line x1="80" y1="215" x2="55" y2="145" />
          <line x1="55" y1="145" x2="90" y2="75" />
          <line x1="90" y1="75" x2="160" y2="50" />
        </g>

        <circle cx="160" cy="160" r="70" fill="#001A2C" opacity="0.85" />
